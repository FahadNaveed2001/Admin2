...
const Dashboard = () => {
  return (
    <div className="p-4 bg-white w-screen lg:w-screen xl:w-screen overflow-hidden md:mx-auto md:mt-[50px] mt-[50px]">
    ...
    <div className="grid grid-cols-12 gap-4  ">
            ...
            <div className="flex flex-row bg-[#38bff828] shadow-lg text-black rounded-2xl p-4 transition ease-in-out delay-150  duration-100">
                ...
                <div className="flex flex-col flex-grow ml-4">
                  <div className="text-sm text-black">Users</div>
            ...
            <div className="flex flex-row bg-[#38bff828] shadow-lg text-black  rounded-2xl p-4 transition ease-in-out delay-150  duration-100">
                ...
                <div className="flex flex-col flex-grow ml-4">
                <div className="text-sm text-black">New Clients</div>
            ...
            <div className="flex flex-row bg-[#38bff828] shadow-lg text-black rounded-2xl p-4 transition ease-in-out delay-150  duration-100">
                ...
                <div className="flex flex-col flex-grow ml-4 ">
                <div className="text-sm text-black">Revenue</div>
