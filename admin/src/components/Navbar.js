        ...
        <div className="w-full navbar bg-[white] h-[7vh] z-10 border-b-2">
          ...
          <div className="flex-none items-center">
            <div className="dropdown dropdown-bottom">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-[250px] ml-[-190px] mt-[10px] divide-y divide-slate-700 "
              >
                <li>
                  <a>
              ...
              <li className="text-[20px] mt-[-2px]">
                <div className="dropdown dropdown-bottom hover:bg-transparent ">
                  <div
                    tabIndex={0}
                    role="button"
                    className="btn bg-transparent hidden md:flex lg:flex border-none p-2 text-[20px] text-[#38BDF8] hover:bg-transparent hover:text-[#32718b]  md:ml-[0]"
                  >
                    <BsStack />
                  </div>
                  <ul
                    tabIndex={0}
                    className="grid grid-cols-3 gap-8 dropdown-content z-[1] menu p-5 shadow bg-base-100 rounded-box w-[300px] ml-[-220px] mt-[10px] items-center "
                  >
                    <li>
              ...
              <li className="text-[20px] mt-[-2px]">
                <div className="dropdown dropdown-bottom hover:bg-transparent">
                  <div
                    tabIndex={0}
                    role="button"
                    className="btn bg-transparent border-none p-2 text-[25px] text-[#38BDF8] hover:bg-transparent hover:text-[#32718b]"
                  >
                    <IoNotifications />
                  </div>
