...
const Schedule = () => {
  return (
    ...
    <div className="text-center text-[#000000] text-[20px] font-bold md:text-start md:text-[50px] md:mx-5"><h1>This Week Schedule</h1></div>
      <div className="flex flex-col md:flex-row">
        <Calendar1 />
        <Calendar2 />
        <Calendar3 />
    ...
    <div className="md:mx-[80px] flex flex-col border-opacity-50 h-[800px] mt-[110px] px-9">
