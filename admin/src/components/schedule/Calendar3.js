    ...
    <div className="max-w-sm w-full shadow-lg ">
      <div className="md:p-8 p-3 dark:bg-gray-800 bg-white rounded-t">
        <div className="px-4 flex items-center text-center">
          <span tabIndex="0" className="font-bold text-gray-800 ">14/March/2024</span>
              ...
              <tr>
                <th>
                  <div className="w-full flex justify-center">
                    <p className="text-[30px] font-Bold text-center text-gray-800 dark:text-gray-100">Wednesday</p>
                  </div>
                </th>
        ...
        <div className="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-[#38bff828] rounded-b">
          <div className="px-4">
            <div className="border-b pb-4 border-gray-400 border-dashed">
              ...
              <a tabIndex="0" className=" text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Zoom call with Finance team</a>
              <p className="text-sm pt-2 text-gray-600 dark:text-gray-300">Discussion on Finance review</p>
            </div>
